...
import v2.retrieveItsaStatus.def1.model.response.{HipItsaStatusDetails, HipItsaStatuses}
import v2.retrieveItsaStatus.model.response.RetrieveItsaStatusResponse

import scala.concurrent.Future

class RetrieveItsaStatusHipConnectorSpec extends ConnectorSpec {

  private val nino    = "AA111111A"
  private val taxYear = TaxYear.fromMtd("2023-24")

  private val itsaStatusDetails = HipItsaStatusDetails("2023-05-23T12:29:27.566Z", `No Status`, `Sign up - return available`, Some(23600.99))
  private val itsaStatuses      = HipItsaStatuses(taxYear.asMtd, Some(List(itsaStatusDetails)))
  private val responseModel     = Def1_RetrieveItsaStatusHipResponse(List(itsaStatuses))
  ...
  private trait Test {
    ...
    val connector: RetrieveItsaStatusHipConnector = new RetrieveItsaStatusHipConnector(
      http = mockHttpClient,

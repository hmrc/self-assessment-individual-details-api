...
import v2.retrieveItsaStatus.def2.model.response.StatusEnum.`Digitally Exempt`

class ItsaStatusesSpec extends UnitSpec {

  private val itsaStatusDetails: ItsaStatusDetails = ItsaStatusDetails("2018-01-01", `Digitally Exempt`, `MTD ITSA Opt-In`, Some(50000.25))

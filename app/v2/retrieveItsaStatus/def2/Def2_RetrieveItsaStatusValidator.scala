...
@Singleton
class Def2_RetrieveItsaStatusValidator(nino: String, taxYear: String, futureYears: Option[String], history: Option[String])
  ...
  def validate: Validated[Seq[MtdError], RetrieveItsaStatusRequestData] =
    ...
    ).mapN(Def2_RetrieveItsaStatusRequestData.apply)
